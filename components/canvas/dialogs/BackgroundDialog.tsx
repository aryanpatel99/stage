            ...
            <div className="space-y-4 sm:space-y-5">
              ...
              <div className="space-y-2">
                ...
                <div className="grid grid-cols-3 gap-2">
                  {[
                    // Professional Linear Gradients - Modern & Elegant
                    { colors: ["#667eea", "#764ba2"], type: "linear" as const, name: "Royal Purple" },
                    { colors: ["#f093fb", "#f5576c"], type: "linear" as const, name: "Vibrant Pink" },
                    { colors: ["#4facfe", "#00f2fe"], type: "linear" as const, name: "Sky Blue" },
                    ...
                    // Professional Radial Gradients - Modern & Elegant
                    { colors: ["#667eea", "#764ba2"], type: "radial" as const, name: "Royal Purple" },
                    { colors: ["#f093fb", "#f5576c"], type: "radial" as const, name: "Vibrant Pink" },
                    { colors: ["#4facfe", "#00f2fe"], type: "radial" as const, name: "Sky Blue" },
                    ...
                    { colors: ["#ff6e7f", "#bfe9ff"], type: "radial" as const, name: "Coral Sky" },
                    ...
                    { colors: ["#fad961", "#f76b1c"], type: "radial" as const, name: "Golden Hour" },
